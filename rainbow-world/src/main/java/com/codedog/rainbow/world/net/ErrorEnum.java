 ...
 */
public class ErrorEnum extends BaseError {
    ...
    //  * 错误的请求
    //  */
    // public static final ERR_BAD_REQUEST(0, "错误的请求"),
    // /**
    //  * 超出最大连接数
    //  */
    ...
    //  * 错误的详细描述
    //  */
    // @Getter private final Object msg;
    //
    // ErrorEnum(int code, Object msg) {
    //     this.code = code;
    //     this.msg = msg;
    // }

    // public JsonPacket toJsonPaket() {
    //     return JsonPacket.ofError(code, msg);
    // }
}
