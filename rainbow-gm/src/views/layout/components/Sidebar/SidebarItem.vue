  ...
  <div v-if="!item.hidden&&item.children" class="menu-wrapper">
    ...
    <el-submenu v-else :index="item.name||item.path">
      ...
      <template v-for="child in item.children" v-if="!child.hidden">
        <sidebar-item v-if="child.children&&child.children.length>0" :key="child.path"
                      :base-path="resolvePath(child.path)" :is-nest="true"
                      :item="child" class="nest-menu"></sidebar-item>
